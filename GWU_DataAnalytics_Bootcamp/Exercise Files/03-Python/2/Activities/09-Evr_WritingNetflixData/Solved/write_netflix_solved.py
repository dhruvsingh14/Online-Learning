...
# Path
path = "C:/Dhruv/Data/1_Active Courses/1_GWU_DataAnalytics_Bootcamp/Exercise Files/03-Python/2/Activities/09-Evr_WritingNetflixData/Solved"

# Set path for file
csvpath = os.path.join(path, "../Resources", "netflix_ratings.csv")

# Specify the file to write to the movie data.
txtpath = os.path.join(path, "../output", "netflix_data.txt")
