...
for this_gamma in [0.0001, 0.001, 0.01, 0.1, 1, 10]:
    ...
    # print('Accuracy of SVC classifier on training set: {:.2f}'.format(clf.score(X_train2, y_train2)))
    # print('Accuracy of SVC classifier on test set: {:.2f}'.format(clf.score(X_test2, y_test2)))
