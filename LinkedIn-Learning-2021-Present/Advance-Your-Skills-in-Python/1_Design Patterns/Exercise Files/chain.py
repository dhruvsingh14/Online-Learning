...
class Client: # Using handlers
	def __init__(self):
		...
		self.handler = ConcreteHandler1(DefaultHandler(None)) # needs to specify who is its successor                                                       # Note that the default handler has no successor
...
# Create a client
c = Client() # actually using the classes we create
