class House(object): #The class being visited 
	...
	def work_on_hvac(self, hvac_specialist): # method, work done by
	...
	def work_on_electricity(self, electrician): # method, work done by
...
class Visitor(object):
	...
	def __str__(self):
		...
		return self.__class__.__name__ # decide on what to be displayed
