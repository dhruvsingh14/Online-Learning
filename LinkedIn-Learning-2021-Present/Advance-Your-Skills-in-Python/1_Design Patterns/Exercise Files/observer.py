class Subject(object): #Represents what is being 'observed'
	...
	def detach(self, observer): #Simply remove the observer
		try:
			self._observers.remove(observer) # removes observer from observer list
		except ValueError:
			pass

	def notify(self, modifier=None): # most important method in subject class
...
class Core(Subject): #Inherits from the Subject class
	...
	def __init__(self, name=""):
		...
		self._name = name #Set the name of the core # main, sets temperature
